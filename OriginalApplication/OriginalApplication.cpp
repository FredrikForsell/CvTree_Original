// OriginalApplication.cpp : Defines the entry point for the console application.
//  H:\CAB401\CAB401_CVTREE_ORIGINAL\OriginalApplication\OriginalApplication\list.txt
...
void Init()
{
	...
	vector = new long[M];
	second = new long[M1];
	second_div_total = new double[M1];
	t = new double[M];
}
